...
if (isset($_POST['add'])) {
    ...
    echo "<script>window.location.href='index.php?view=cat-product'</script>";
    exit();
}
?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <?php while ($row_category_product = mysqli_fetch_array($query_category_product)) { ?>
                            <tr>
                                <td><?php echo $row_category_product['TenDanhMuc'] ?></td>
                                <td><?php echo $row_category_product['Mota'] ?></td>
                                <td class="d-flex">
                                    <a href="views/fixCategory.php?id=<?php echo $row_category_product['ID_DanhMuc'] ?>"
                                       class="btn btn-success btn-sm rounded-0 text-white mr-2" type="button"
                                       data-toggle="tooltip" data-placement="top" title="Edit"><i
                                                class="fa fa-edit"></i></a>
                                    <a href="views/deleteCategory.php?id=<?php echo $row_category_product['ID_DanhMuc'] ?>"
